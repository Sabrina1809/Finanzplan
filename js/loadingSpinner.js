...
function saveAcceptButton() {
    ...
    setTimeout(() => {document.querySelector(".loading_spinner_ctn").style.display = "none"}, 3500)
    setTimeout(() => {document.querySelector(".loading_img_ctn").style.display = "none"}, 3500)
}